          ...
          <div className="divide-y divide-legal-border/30">
            {filteredNotifications.map((notification, index) => (
              <motion.div
                ...
                className={`p-6 hover:bg-legal-bg-secondary/20 transition-colors cursor-pointer relative ${
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="p-1 text-legal-warm-text hover:text-accent-600 transition-colors rounded"
                    >
      ...
      >
        {[
          ...
          <motion.div
            ...
            className="bg-white/95 backdrop-blur-sm rounded-xl shadow-legal border border-warm-200/50 p-4 text-center"
          >
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button
            ...
            className="flex flex-col items-center p-4 border border-legal-border rounded-lg hover:bg-legal-bg-secondary/20 transition-colors"
          >
            <Settings className="w-6 h-6 text-legal-warm-text mb-2" />
            <span className="text-sm font-montserrat text-legal-dark-text">Settings</span>
          </button>
          <button
            onClick={() => window.location.href = '/dashboard/calendar'}
            className="flex flex-col items-center p-4 border border-legal-border rounded-lg hover:bg-legal-bg-secondary/20 transition-colors"
          >
            <Calendar className="w-6 h-6 text-legal-warm-text mb-2" />
            <span className="text-sm font-montserrat text-legal-dark-text">Calendar</span>
          </button>
          <button
            onClick={() => window.location.href = '/dashboard/sessions'}
            className="flex flex-col items-center p-4 border border-legal-border rounded-lg hover:bg-legal-bg-secondary/20 transition-colors"
          >
            <User className="w-6 h-6 text-legal-warm-text mb-2" />
            <span className="text-sm font-montserrat text-legal-dark-text">Sessions</span>
          </button>
          <button
            onClick={() => window.location.href = '/dashboard/messages'}
            className="flex flex-col items-center p-4 border border-legal-border rounded-lg hover:bg-legal-bg-secondary/20 transition-colors"
          >
            <MessageSquare className="w-6 h-6 text-legal-warm-text mb-2" />
            <span className="text-sm font-montserrat text-legal-dark-text">Messages</span>
          </button>
        </div>
      </motion.div>
