...
export default function FeaturesSection() {
  return (
    <section id="features" className="py-20 bg-white/50 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-legal-lg border border-warm-200/50 p-8 hover:shadow-legal-xl transition-all duration-300 text-center group-hover:scale-105 h-full">
                {/* Icon */}
                ...
                {/* Content */}
                <h3 className="text-xl font-bold text-legal-dark-text mb-4 font-baskervville group-hover:text-accent-700 transition-colors">
                  {feature.title}
                </h3>
                <p className="text-legal-warm-text leading-relaxed font-montserrat">
                  {feature.description}
                </p>
              </div>
            </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-accent-700 to-accent-600 rounded-3xl p-8 lg:p-12 text-white relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              <h3 className="text-3xl lg:text-4xl font-baskervville font-bold mb-4">
                Even More Features
              </h3>
              <p className="text-white/90 text-lg font-montserrat max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {additionalFeatures.map((feature, index) => (
                ...
                >
                  ...
                  <h4 className="text-lg font-semibold mb-2 font-baskervville">
                    {feature.title}
                  </h4>
        ...
        >
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-legal-lg border border-warm-200/50 p-8 lg:p-12 max-w-4xl mx-auto">
            <h3 className="text-2xl lg:text-3xl font-baskervville font-bold text-legal-dark-text mb-4">
              Ready to Start Your Mentoring Journey?
            </h3>
            <p className="text-legal-warm-text font-montserrat text-lg mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-accent-700 to-accent-600 text-white font-semibold py-4 px-8 rounded-xl shadow-legal-lg hover:shadow-legal-xl transition-all duration-300 hover:scale-105 font-montserrat">
                Get Started Today
              </button>
              <button className="bg-white text-accent-700 font-semibold py-4 px-8 rounded-xl border border-accent-200 shadow-warm hover:shadow-warm-lg transition-all duration-300 hover:scale-105 font-montserrat">
                Learn More
              </button>
            </div>
          </div>
